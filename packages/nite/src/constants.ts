...
export const CLIENT_PUBLIC_PATH = `/@nite/client`
export const ENV_PUBLIC_PATH = `/@nite/env`
export const nite_PACKAGE_DIR = resolve(
...
//   to the TypeScript declaration file `packages/nite/client.d.ts` and
//   add a mime type to the `registerCustomMime` in
//   `packages/nite/src/node/plugin/assets.ts` if mime type cannot be
//   looked up by mrmime.
